...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      content: "",
      featured_image: "",
      apiUrl: "https://garyduncan.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  deleteImage(imageType) {
    axios
      ...
      .catch((error) => {
        console.log("Error: Error with deleting image", error);
      });
  }
  ...
  componentDidMount(props) {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://garyduncan.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
